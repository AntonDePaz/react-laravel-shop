...
export const AddProduct = () => {
    ...
    const submitAddproduct = (e) => {
       ...
       axios.post(`/api/store-product`, formData).then((response)=>{
        ...
        <div className='container'>
            <div className='card mt-4'>
                ...
                <div className='card-body'>
                    <form encType='multipart/form-data' onSubmit={submitAddproduct}>
                   ...
                   <nav>
                        <div class="nav nav-tabs" id="nav-tab" role="tablist">
                            ...
                            <button class="nav-link" id="nav-profile-tab1" data-bs-toggle="tab" data-bs-target="#nav-profile1" type="button" role="tab" aria-controls="nav-profile1" aria-selected="false">More Details</button>
                        </div>
                    </nav>
                    <div class="tab-content" id="nav-tabContent">
                        <div class="tab-pane card-body border fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                        ...
                        <div class="tab-pane card-body border fade" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab">
                        ...
                        <div class="tab-pane card-body border fade" id="nav-profile1" role="tabpanel" aria-labelledby="nav-profile-tab1">
